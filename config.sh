...
export DEPS_DEB="fakeroot make ca-certificates less git vim devscripts debhelper \
  ...
  libmilter-dev bison flex libmagic-dev git ragel libfann-dev libjemalloc-dev libmemcached-dev ragel libicu-dev ninja"
...
export DEPS_RPM="glib2-devel libevent-devel openssl-devel pcre-devel perl \
  ...
  flex file-devel fann-devel git rsync perl-Digest-MD5 libmemcached-devel ragel perl-Digest-MD5 gd-devel libicu-devel jemalloc-devel ninja"

export MAIN_ARCH="x86_64"
export RSPAMD_VER_UNSTABLE="1.7.2"
export RSPAMD_VER_STABLE="1.7.1"
